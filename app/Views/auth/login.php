    ...
    <form action="<?= site_url('/auth/login') ?>" method="post">
      ...
      <div class="field-group">
        ...
        <div class="input-wrap">
          ...
          <input name="email" type="email" placeholder="vous@exemple.com" value="<?= esc(old('email') ?: 'admin@gmail.com') ?>" required />
        </div>
      </div>
      ...
      <div class="field-group">
        ...
        <div class="input-wrap">
          ...
          <input name="password" type="password" placeholder="••••••••" value="<?= esc(old('password') ?: 'admin123') ?>" required />
        </div>
      </div>
